<template>
    <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Data Catalogue</h1>
        </div>
        ...
        <div class="card shadow">
            <div class="card-body">
                <form @submit.prevent="editDataCatalogue">
...
export default {
    ...
    methods: {
        async editDataCatalogue(){
            try {
                const { data } = await axios.patch(`/api/admin-catalogue/${this.$route.params.id}`, this.catalogue)
                .then(response=>{
