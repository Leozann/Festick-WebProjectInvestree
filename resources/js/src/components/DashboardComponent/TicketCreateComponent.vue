<template>
    <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Data Ticket</h1>
        </div>
        <a href="admin-show-ticket" class="btn btn-sm btn-primary shadow mb-3">Back</a>
        <div class="card shadow">
            <div class="card-body">
                <form @submit.prevent="createDataTicket">
...
export default {
    ...
    methods: {
        async createDataTicket(){
            try {
                await axios.post('api/admin-ticket', this.ticket).then(response=>{
